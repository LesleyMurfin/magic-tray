...
- **Magic Mouse 2024, USB-C, PID `0323`.** Pick **KMDF**. It is the only choice that gives you
  ...
  [not installable from the tray yet](../README.md#just-want-a-2024-magic-mouse-driver).
...
- [README, Scroll](../README.md#scroll) - install steps, Test Mode prerequisites, and the mouse
  catalog with tested-hardware status.

...
- 0323 Best **pulls** `v2-kmdf-driver` and runs **that repo’s KMDF one-click** (0323 only). Never PATH-A `Install-MagicMousePatch.ps1`. Do not vendor those scripts here.

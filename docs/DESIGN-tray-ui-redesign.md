...
- 0323 Best **pulls the default branch** and runs `v2-kmdf-driver/Install-KMDF.cmd` (0323 only; SYSTEM tasks `MM-Kmdf-Install` / `MM-Kmdf-PostBoot`). Never PATH-A `Install-MagicMousePatch.ps1`. If the cmd is missing on default, report and stop. Do not vendor those scripts here.

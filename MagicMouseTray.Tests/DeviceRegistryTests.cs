...
// and ranks a real percentage above -2 above -1 (AdaptivePoller.cs:131-143), so it only needs
...
public class DeviceRegistryTests
{
    ...
    const string UsbRoot = @"\\?\usb#vid_05ac&pid_0323#j84hj804ysb000053a";
    ...
    // The exact path set from the live log: every distinct col02 interface must survive, and
